class StoveRunner{
	...
	{
		System.out.println("running main Stove");
Stove ref1=new Stove("prestige","kitchen",10000.0,"black",50,40,"vimal",80);
Stove ref2=new Stove("frigidaire","electric",8000.0,"pink",40,32,"ambika",50);
Stove ref3=new Stove("pigeon","wood",9000.0,"brown",33,53,"surya",90);
Stove ref4=new Stove("sunflame","induction",60000.0,"red",60,84,"srhome",70);
Stove ref5=new Stove("mors","oven",2000.0,"green",55,16,"kgn",108);
Stove ref6=new Stove("elica","multi_fuil",20000.0,"white",90,47,"maruthi",40);
Stove ref7=new Stove("glen","types1",14000.0,"blue",60,88,"chamundigas",50);
Stove ref8=new Stove("dacor","gasstove",16400.0,"yellow",107,40,"fayaz",60);
