class SofaRunner{
	...
	{
		System.out.println("running main sofa");
Sofa ref1=new Sofa("la-z-boy","loveseat",30000.0,"black",1,20,"sofashop",120);
Sofa ref2=new Sofa("burrow","sofabed",18000.0,"pink",5,12,"patioking",50);
Sofa ref3=new Sofa("allmodern","divan",19000.0,"brown",3,13,"cushy",300);
Sofa ref4=new Sofa("ashley","tuxedo",60000.0,"red",2,14,"viewfull",800);
Sofa ref5=new Sofa("catnapper","velvet",20000.0,"green",5,16,"freshcouch",18);
Sofa ref6=new Sofa("broyhill","recliner",50000.0,"white",10,17,"couchly",40);
Sofa ref7=new Sofa("casstlery","settee",34000.0,"blue",6,18,"empiredesign",70);
Sofa ref8=new Sofa("eq3","cornersofa",76400.0,"yellow",7,4,"boho",40);
