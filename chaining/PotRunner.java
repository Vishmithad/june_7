class PotRunner{
	...
	{
		System.out.println("running main Pot");
Pot ref1=new Pot("lecreuset","deconditioning",300.0,"black",1,20,"rishi",20);
Pot ref2=new Pot("greenpan","saucepan",180.0,"pink",5,12,"cs",50);
Pot ref3=new Pot("ourplace","ceramic",190.0,"brown",3,13,"pottery",30);
Pot ref4=new Pot("ashley","dutch",600.0,"red",2,14,"aurovik",80);
Pot ref5=new Pot("cello","sauces",200.0,"green",5,16,"hira",28);
Pot ref6=new Pot("borosil","metal",500.0,"white",10,17,"fuss",40);
Pot ref7=new Pot("sumeet","secondarypots",340.0,"blue",6,18,"ajaneya",40);
Pot ref8=new Pot("prestige","hypera",764.0,"yellow",7,4,"jayanagar",20);
